    ...
    <div className="min-h-screen text-parchment font-sans selection:bg-bronze/30 selection:text-white relative overflow-x-hidden bg-primary">
      ...
      <div className="max-w-md mx-auto p-4 min-h-screen flex flex-col relative z-20">
        ...
        <header className="text-center mb-12 relative z-10">
          {/* Logo Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-bronze/10 rounded-full blur-3xl -z-10 animate-pulse"></div>

          <div className="mb-6 flex justify-center">
            <img
              src="/images/logo_bw.png"
              alt="Обережье"
              className="h-32 w-auto object-contain drop-shadow-[0_0_25px_rgba(212,175,55,0.2)] opacity-90 hover:opacity-100 transition-opacity duration-700"
            />
          </div>
      ...
      <div className="w-full max-w-2xl mt-12 space-y-8 mx-auto px-6 pb-12 relative z-20">
        {/* Подписка */}
